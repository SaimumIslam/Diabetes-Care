...
public class AvoidDrugDbAdapter {

    myDbHelper myhelper;

    public AvoidDrugDbAdapter(Context context)
    {
    ...
    {
        private static final String DATABASE_NAME = "hkuhgg";    // Database Name
        private static final String TABLE_NAME = "Drug";   // Table Name
